...
const DsoBoard = React.lazy(() => import('v1/pages/invest/pages/dso-board'))
const DsoView = React.lazy(() => import('v1/pages/invest/pages/dso-view'))
const AddCommitment = React.lazy(() => import('v1/pages/invest/pages/commit'))
const ViewCommitment = React.lazy(() =>
  import('v1/pages/invest/pages/view-commitment')
)
