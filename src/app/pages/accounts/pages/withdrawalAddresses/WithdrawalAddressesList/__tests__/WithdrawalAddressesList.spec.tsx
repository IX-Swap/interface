...
jest.mock(
  'app/pages/accounts/pages/withdrawalAddresses/WithdrawalAddressCreate/WithdrawalAddressCreate',
  () => ({ WithdrawalAddressCreate: jest.fn(() => null) })
)
jest.mock(
  'app/pages/accounts/pages/withdrawalAddresses/WithdrawalAddressView/WithdrawalAddressView',
