...
export const DepositFormFields: React.FC = () => {
  const [clearFormConfirmationVisible, setClearFormConfirmationVisible] =
    useState(false)
  const [depositConfirmationVisible, setDepositFormConfirmationVisible] =
    useState(false)
  ...
  return (
    <>
      ...
      <Box display={'flex'} gap={3}>
        ...
        <Button
          onClick={() => setDepositFormConfirmationVisible(true)}
          variant='contained'
          color='primary'
          disableElevation
          disabled={hasError}
      ...
      <ConfirmDepositDiaglog
        ...
        close={() => setDepositFormConfirmationVisible(false)}
        confirm={sendToken}
