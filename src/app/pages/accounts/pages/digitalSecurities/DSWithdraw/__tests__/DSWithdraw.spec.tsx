...
jest.mock(
  'app/pages/accounts/pages/digitalSecurities/DSWithdraw/WithdrawForm',
  () => ({
...
jest.mock(
  'app/pages/accounts/pages/digitalSecurities/DSWithdraw/WithdrawView',
  () => ({ WithdrawView: jest.fn(() => null) })
)

jest.mock(
  'app/pages/accounts/pages/digitalSecurities/DSWithdraw/RecentWithdrawals',
  () => ({
