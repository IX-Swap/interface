...
export const CryptoHoldingContent = () => {
  return (
    <>
      <Grid container justifyContent='center' spacing={2}>
        <Grid item>
          ...
          <Typography color={'text.secondary'} fontWeight={500}>
            ...
            should clearly show your: <br />
            <br /> (1) your full name; <br /> (2) date of statement; <br />
        ...
        <Grid item>
          ...
          <Typography color={'text.secondary'} fontWeight={500}>
            ...
            <ul>
              <li>
                Have net personal assets exceeding S$2,000,000 (or its
                equivalent in foreign currency), of which net equity of the
                individual’s primary residence is no more than S$1,000,000.{' '}
              </li>
            </ul>
      ...
      <Grid item sx={{ borderTop: '1px solid #DBE2EC' }} mt={3} pt={3}>
        <Typography
          color={'text.secondary'}
          sx={{ fontSize: '12px', color: '#778194' }}
          fontWeight={500}
        >
          <sup>1</sup> If you submit CSV files as proof of cryptocurrency
          holdings, we may come back to you with some more clarifications. We
          will assess each CSV file submitted as a proof of cryptocurrency
        ...
        <Typography
          ...
          mt={1}
        >
          <sup>2</sup> We will accept and assess the statements from exchanges
          or wallet screenshots on a case by case basis.
        </Typography>
      </Grid>
    </>
  )
