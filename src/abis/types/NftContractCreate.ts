...
export interface NftContractCreateInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'getTokenId', values?: undefined): string
...
export interface NftContractCreate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: NftContractCreateInterface
