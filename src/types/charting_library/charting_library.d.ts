...
export interface ChartingLibraryWidgetOptions {
  ...
  timeframe?: string
  timezone?: 'exchange' | Timezone | string
  toolbar_bg?: string
  width?: number | string
...
export interface IBrokerConnectionAdapterHost {
  ...
  positionPartialUpdate: (
    id: string,
    positionChanges: Partial<Position>
  ) => void
...
export interface IChartWidgetApi {
  ...
  crossHairMoved: (
    callback: (params: CrossHairMovedEventParams) => void
  ) => void
  setVisibleRange: (
...
export interface IOrderLineAdapter {
  ...
  onModify: ((callback: () => void) => this) &
    (<T>(data: T, callback: (data: T) => void) => this)
