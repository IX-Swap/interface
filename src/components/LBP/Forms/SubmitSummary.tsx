...
interface Props {
  formData: FormData
  startPrice: number
  projectTokenTitle: string
  onCancel: () => void
}

export const SubmitSummary = ({ projectTokenTitle, formData, onCancel, startPrice }: Props) => {
      ...
      <Section>
        <Row>
          <TextBlock>
            ...
            <FieldValue>{formatNumberWithDecimals(startPrice, 3)}</FieldValue>
          </TextBlock>
          <TextBlock>
