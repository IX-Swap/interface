...
export default function Loader({
  ...
  return (
    <StyledRotatingSVG
      ...
      size={size}
      stroke={stroke ?? theme.launchpad.colors.primary}
      {...rest}
    >
      <path
...
export function LoaderV2() {
  ...
  return (
    <StyledRotatingSVG size="16px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <StyledSVG size="16px" viewBox="0 0 16 16" fill={theme.launchpad.colors.primary} xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export function LoaderV3({ size = '16px', color, ...rest }: { size?: string; color?: string; [k: string]: any }) {
  ...
  return (
    <StyledRotatingSVG
      ...
      viewBox="0 0 54 54"
      xmlns="http://www.w3.org/2000/svg"
      fill={color ?? theme.launchpad.colors.primary}
      stroke={color ?? theme.launchpad.colors.primary}
      {...rest}
    >
      <path
        opacity="0.1"
