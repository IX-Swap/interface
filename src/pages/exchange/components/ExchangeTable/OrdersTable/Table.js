      ...
      {list.map((row, i) => {
        ...
        return (
          <TableRow key={i}>
            ...
            <TableCell className={classes.defaultCell}>{row.average}</TableCell>
            <TableCell className={classes.defaultCell}>{row.price}</TableCell>
            <TableCell className={classes.defaultCell}>{row.filled}</TableCell>
            <TableCell className={classes.defaultCell}>{row.amount}</TableCell>
            <TableCell className={classes.defaultCell}>{row.total}</TableCell>
