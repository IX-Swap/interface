...
const CreatePayoutEvent = lazy(() => import('pages/CreateNFT/CreatePayoutEvent'))
const EditPayoutEvent = lazy(() => import('pages/CreateNFT/CreatePayoutEvent/EditPayoutEvent'))
