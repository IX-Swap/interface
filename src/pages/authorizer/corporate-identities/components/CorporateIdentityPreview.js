...
import CorporateIdentityForm from 'pages/identity/pages/corporate/CorporateIdentityForm'
...
const CorporateIdentityPreview = ({ onClickBack, identity }) => {
        ...
        <Container>
          ...
          <IdentityProvider>
            <CorporateIdentityForm
              corporate={{ ...identity, declarations }}
              editMode={false}
