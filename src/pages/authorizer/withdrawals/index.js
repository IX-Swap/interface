...
const RowStatusComponent = ({
  ...
  switch (withdraw.status) {
    case 'Approved':
      return <Typography className={classes.formControl} color="primary">Approved</Typography>;
    case 'Rejected':
      return <Typography className={classes.formControl} color="error">Rejected</Typography>;
    default:
      return (
        <Select
