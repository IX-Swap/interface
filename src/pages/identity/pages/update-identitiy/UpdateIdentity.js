...
import { Grid, Card, Box, CircularProgress, Typography, TextField, Button, IconButton, Snackbar } from '@material-ui/core'
...
import { MARITAL_STATUSES_OPTS, GENDERS_OPTS, COUNTRIES_OPTS, YES_OR_NO_OPTS } from 'const'
...
import { useAccreditationState, useAccreditationDispatch, ACCREDITATION_STATUS, getAccreditation, saveAccreditation } from 'context/AccreditationContext'
import { useIdentityState, useIdentityDispatch, IDENTITY_STATUS, getIdentity, selectFile, saveIdentity, saveFinancials, saveFile } from 'context/IdentityContext'
      ...
      <Grid item xs={12} sm={10} md={8}>
        ...
        {error ? (
          ...
          <Card component='form' onSubmit={handleSubmit}>
            <Box p={3}>
              <Typography component='h1' variant='h3'>Update My Identity</Typography>
              ...
              <Box component='section' mt={8}>
                <Box mb={1}>
                  <Typography component='h2' variant='h5'>Address</Typography>
                </Box>
              ...
              <Box component='section' mt={8}>
                <Box mb={1}>
                  <Typography component='h2' variant='h5'>Occupation</Typography>
                </Box>
              ...
              {/* Bank Account Fields */}
              <Box component='section' mt={8}>
                <Typography component='h2' variant='h5'>Bank Account</Typography>
              ...
              <Box component='section' mt={6}>
                <Typography component='h2' variant='h5'>Income</Typography>
              ...
              <Box component='section' mt={6}>
                <Typography component='h2' variant='h5'>Self-Accredited Investor</Typography>

                <Box mt={1}>
                  <Typography>Are you an accredited investor?</Typography>
                  <Box maxWidth='12rem'>
                    <SelectGroup displayEmpty margin='none' fullWidth label='' {...fields.selfAccreditedInvestor} />
                  </Box>
                </Box>
              </Box>
              ...
              {/* Declarations */}
              <Box component='section' mt={6}>
                <Typography component='h2' variant='h5'>Declarations</Typography>
              ...
              <Box component='section' mt={6}>
                <Box mb={1}>
                  <Typography component='h2' variant='h5'>Proof of wealth</Typography>
                </Box>
                <UploadSection
              ...
              <Box display='flex' justifyContent='flex-end' mt={8}>
                <Button disabled={!isValid || isSaving} type='submit' variant='contained' color='primary'>
                  {isSaving
                    ? 'Saving...'
                    : 'Save Changes'}
                </Button>
...
const useUpdateIdentityLogic = () => {
  ...
  const { handleSubmit: rhfHandleSubmit, errors, control, setValue, formState, watch, triggerValidation, register, getValues } = methods
  ...
  const isIdDataPresent = typeof id.identity === 'object'
    && Object.keys(id.identity).length
  const isAcrdDataPresent = typeof acrd.accreditation === 'object'
  ...
  const fields = {
    ...
    totalPersonalAssetExceedsTwoMillionSGD:
      createFieldProps('totalPersonalAssetExceedsTwoMillionSGD', {
        options: YES_OR_NO_OPTS, required: true
      }),
