...
export const PromoTokenCard = ({ stakingStatus }: { stakingStatus: StakingStatus }) => {
  ...
  return (
    <RowCenter style={{ position: 'relative' }}>
      <StakingPlaceholder />
        ...
        <RowCenter id="promo-staking-wrapper">
          ...
          <Column id="main-info-col">
            <Box>
              <TYPE.body3>
                <Trans>
                  Staking is a great way to maximize the value of your holdings, instead of letting them sit idle in
                  your {currency?.symbol} account!
                  <br /> Once you have staked your assets, you can earn rewards on your holdings. This allows you to
                  grow your token holdings over time.
                </Trans>
              </TYPE.body3>
            </Box>
            <Box marginTop={18}>
