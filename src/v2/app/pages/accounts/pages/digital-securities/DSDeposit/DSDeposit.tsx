...
import { RecentDeposits } from 'v2/app/pages/accounts/pages/digital-securities/DSDeposit/RecentDeposits'
import { DepositView } from 'v2/app/pages/accounts/pages/digital-securities/DSDeposit/DepositView'
