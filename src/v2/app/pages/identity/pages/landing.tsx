...
import { useStore as useGlobalIdentityStore } from 'v2/context/identity'
import { useStore as useIdentityPageStore } from 'v2/app/pages/identity/context'
import storageHelper from 'v2/helpers/storageHelper'
import IdentitySection from 'v2/app/components/identity-forms/components/section'
import UserInfoComponent from 'v2/app/components/identity-forms/components/user-info'
import CompanyInformation from 'v2/app/components/identity-forms/components/company-info'
