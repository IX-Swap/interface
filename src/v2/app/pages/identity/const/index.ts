import { arrToOpts } from 'v2/helpers/arrays'
import nationalities from 'v2/app/pages/identity/const/nationalities'

export * from 'v2/app/pages/identity/const/countries'
