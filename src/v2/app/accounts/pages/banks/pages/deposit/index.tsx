...
import DepositList from 'v2/app/accounts/pages/banks/pages/deposit/list'
import DepositForm from 'v2/app/accounts/pages/banks/pages/deposit/form'
import { noop } from 'lodash'

import BankDetails from 'v2/app/components/bank-details'
import { INVESTAX_BANK } from 'v2/config'
import { generateRandom, formatMoney } from 'v2/helpers/numbers'
import GenericPreview from 'v2/app/components/generic-preview'
import { useStore as useAssetsStore } from 'v2/context/assets'
import { LabelValue } from 'v2/types/util'
