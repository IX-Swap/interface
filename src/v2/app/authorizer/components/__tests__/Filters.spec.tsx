...
import { Filters, FiltersProps } from 'v2/app/authorizer/components/Filters'

jest.mock('v2/app/authorizer/components/StatusFilter', () => ({
  StatusFilter: jest.fn(() => <div data-testid='status-filter' />)
}))
jest.mock('v2/app/authorizer/components/SearchAndDateFilter', () => ({
