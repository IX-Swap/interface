...
import { AuthorizerView } from 'v2/app/authorizer/components/AuthorizerView'
import {
  useAuthorizerView,
...
jest.mock('v2/app/authorizer/components/Filters', () => ({
  Filters: jest.fn(() => null)
}))
jest.mock('v2/app/authorizer/components/Preview', () => ({
  Preview: jest.fn(() => null)
}))
jest.mock('v2/app/authorizer/hooks/useAuthorizerView')
