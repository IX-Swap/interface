...
import LIQUIDITY_ABI from 'abis/LiquiidtyBoostrapPool.json'
import {
...
export function useLBPShareContract(contractAddress: string) {
  return useContract(contractAddress, LIQUIDITY_ABI)
}