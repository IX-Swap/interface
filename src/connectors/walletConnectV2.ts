...
const MAINNET_IXS_DOMAINS = ['app.ixswap.io', 'staging-client-demo.ixswap.io', 'localhost']
  ...
  (actions) =>
    new WalletConnectV2({
      ...
      options: {
        ...
        chains: [MAINNET_IXS_DOMAINS.includes(window.location.hostname) ? POLYGON_CHAIN_ID : POLYGON_MUMBAI_CHAIN_ID],
