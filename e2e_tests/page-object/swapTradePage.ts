...
export class SwapTradePage extends WebPage {
  ...
  constructor(page: Page, context?: BrowserContext) {
    ...
    this.rejectTransactionPopUp = page.locator(
      `[data-testid="TransactionPopup"] >> text=${this.rejectTransactionPopUpText}`
    )
    this.transactionSubmittedPopUpText = page.locator(
      `[data-testid="submittedDialog"] >> text=${this.transactionSubmittedText}`
    )
  }
